  ...
  return (
    <div>
      ...
      <div className="px-6 md:px-[200px] mt-8 mb-10">
        <p className="font-bold md:text-2xl text-xl">Create a post</p>
        ...
        className='px-4 py-2 outline-none border border-solid border-black'/>
          ...
          <div className="flex flex-col">
              ...
              <div className="flex flex-col md:w-full max-w-fit  md:flex-row gap-2 mt-3 mb-3">
                ...
                <textarea onChange={(e)=>setDesc(e.target.value)} rows={15} cols={30} className='px-4 py-2 border border-solid border-black mb-3 outline-none' 
                placeholder='Enter post description'/>
                <button onClick={handleCreate} className='bg-black w-full md:w-[20%] mx-auto text-white rounded-md hover:bg-gray-700
                font-semibold px-4 py-2 md:text-xl text-lg'>Create</button>  
          </div>
        </form>
      </div>
      <Footer />
